...
const chatNotifying = ref(true)


const toggleChat = () => {
    chatDropdownOpen.value = !chatDropdownOpen.value;
    notifying.value = false
}
</script>
<template>
        ...
        <div class="flex flex-grow items-center justify-between py-4 px-4 shadow-2 md:px-6 2xl:px-11">
            ...
            <div class="flex items-center gap-3 2xsm:gap-7">
                <ul class="flex items-center gap-2 2xsm:gap-4">
                    <li>
                        <!-- Dark Mode Toggler -->
                        <label :class="{'bg-primary': darkMode , 'bg-stroke': !darkMode}"
                            class="relative m-0 block h-7.5 w-14 rounded-full">
                            <input type="checkbox" :value="darkMode" @change="darkMode = !darkMode"
                                class="absolute top-0 z-50 m-0 h-full w-full cursor-pointer opacity-0" />
                            <span
                                :class="{'!right-[3px] !translate-x-full': darkMode}"
                    ...
                    <li class="relative">
                        <a class="relative flex h-8.5 w-8.5 items-center justify-center rounded-full border-[0.5px] border-stroke bg-gray hover:text-primary dark:border-strokedark dark:bg-meta-4 dark:text-white"
                            href="#" @click.prevent="toggleNotification">
                            <span :class="{'hidden': !notifying}"
                        ...
                        <!-- Dropdown Start -->
                        <div v-show="notificationDropdownOpen"
                    ...
                    <li class="relative">
                        <a class="relative flex h-8.5 w-8.5 items-center justify-center rounded-full border-[0.5px] border-stroke bg-gray hover:text-primary dark:border-strokedark dark:bg-meta-4 dark:text-white"
                            href="#" @click.prevent="toggleChat">
                            <span :class="{ 'hidden': !chatNotifying }"
