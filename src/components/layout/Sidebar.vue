...
const selected = ref('');
const selectItem = function (section) {
        ...
        <ul class="mb-6 flex flex-col gap-1.5">
          ...
          <li>
            <a
              ...
              :class="{'bg-graydark': page === 'profile', 'bg-graydark dark:bg-meta-4': (selected === 'Profile') && (page === 'profile')  }"
            >
              <svg
                class="fill-current"
                width="18"
          ...
          <li>
            <a
              ...
              :class="{'bg-graydark': page === 'settings', 'bg-graydark dark:bg-meta-4': (selected === 'Settings') && (page === 'settings')  }"
            >
              <svg
                class="fill-current"
                width="18"
